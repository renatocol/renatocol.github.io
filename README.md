...
Simulador que compara o custo mensal de abastecimento entre um carro elétrico e um carro a gasolina, contemplando dois perfis de usuário: quem possui carregador doméstico e quem depende exclusivamente de carregadores públicos pagos. Os parâmetros são ajustáveis via sliders — tarifas de energia (doméstica e pública), preço da gasolina, eficiência dos veículos e quilometragem mensal. O app inclui modo claro/escuro e salvamento automático das configurações no navegador.
